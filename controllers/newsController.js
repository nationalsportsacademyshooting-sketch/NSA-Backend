...
exports.createNewsEvent = async (req, res) => {
    try {
        ...
        console.log("Create News/Event Error:", error);

        res.status(500).json({
            message: "Unable to create News/Event.",
            error: error.message
        });
    }
};
...
exports.getNewsEvents = async (req, res) => {
    try {
        ...
        console.log("Get News/Event Error:", error);
...
exports.deleteNewsEvent = async (req, res) => {
    try {
        ...
        console.log("Delete News/Event Error:", error);

        res.status(500).json({
            message: "Unable to delete News/Event."
        });
    }
};